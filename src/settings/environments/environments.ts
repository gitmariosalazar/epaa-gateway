...
interface EnvironmentVariables {
  ...
  CUSTOMERS_CONNECTION_KAFKA_CLIENT_ID: string;
  CUSTOMERS_CONNECTION_KAFKA_GROUP_ID: string;
  CUSTOMERS_CONNECTION_KAFKA_CLIENT: string;
}
...
const envVarsSchema: Joi.ObjectSchema<EnvironmentVariables> = Joi.object({
  ...
  CUSTOMERS_CONNECTION_KAFKA_CLIENT_ID: Joi.string(),
  CUSTOMERS_CONNECTION_KAFKA_GROUP_ID: Joi.string(),
  CUSTOMERS_CONNECTION_KAFKA_CLIENT: Joi.string(),
}).unknown();
...
export const environments = {
  ...
  CUSTOMERS_KAFKA_CLIENT_ID: envVars.CUSTOMERS_CONNECTION_KAFKA_CLIENT_ID,
  CUSTOMERS_KAFKA_GROUP_ID: envVars.CUSTOMERS_CONNECTION_KAFKA_GROUP_ID,
  CUSTOMERS_KAFKA_CLIENT: envVars.CUSTOMERS_CONNECTION_KAFKA_CLIENT,
};  