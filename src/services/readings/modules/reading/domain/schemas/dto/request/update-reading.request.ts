...
export class UpdateReadingRequest {
  ...
  @ApiProperty({
    example: 1500,
    description:
      'The consumption value calculated based on the difference between the current and previous readings',
    required: false,
  })
  ...
  @ApiProperty({
    example: '2026-02',
    description: 'The month of the reading in YYYY-MM format',
    required: true,
  })
  readingMonth: string;
}
