...
/**
 * UpdateCurrentReadingUseCase — application layer orchestrator (SRP + DIP).
 * Coordinates the primary "update reading" command and its secondary,
 ...
 */
@Injectable()
export class UpdateCurrentReadingUseCase {
  constructor(
  ...
  async execute(
    ...
    const readingMonth = readingRequest.readingMonth.toString();
    ...
    this.legacySync.syncUpdateReadingLegacy(params, request);
