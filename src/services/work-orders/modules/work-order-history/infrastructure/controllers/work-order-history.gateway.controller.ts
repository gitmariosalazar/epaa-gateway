...
export class WorkOrderHistoryGatewayController implements OnModuleInit {
  ...
  async updateWorkOrderHistory(
    ...
    try {
      ...
      this.logger.error(
        `Error in updateWorkOrderHistory: ${err.message}`,
        err.stack,
      );
  ...
  async getWorkOrderHistoryById(
    ...
    try {
      ...
      const err = error as Error;
      this.logger.error(
        `Error in getWorkOrderHistoryById: ${err.message}`,
        err.stack,
      );
      throw new RpcException(err as string | object);
    }
  ...
  async getWorkOrderHistoriesByWorkOrderId(
    ...
    try {
      ...
      const err = error as Error;
      this.logger.error(
        `Error in getWorkOrderHistoriesByWorkOrderId: ${err.message}`,
        err.stack,
      );
      throw new RpcException(err as string | object);
    }
  ...
  async getAllWorkOrderHistories(
    ...
    try {
      ...
      const err = error as Error;
      this.logger.error(
        `Error in getAllWorkOrderHistories: ${err.message}`,
        err.stack,
      );
      throw new RpcException(err as string | object);
    }
  ...
  async findAllViewHistoriesWorkOrders(
    ...
    try {
      ...
      const err = error as Error;
      this.logger.error(
        `Error in findAllViewHistoriesWorkOrders: ${err.message}`,
        err.stack,
      );
      throw new RpcException(err as string | object);
    }
  ...
  async findAllViewHistoriesWorkOrdersByOrderCode(
    ...
    try {
      ...
      const err = error as Error;
      this.logger.error(
        `Error in findAllViewHistoriesWorkOrdersByOrderCode: ${err.message}`,
        err.stack,
      );
      throw new RpcException(err as string | object);
    }
