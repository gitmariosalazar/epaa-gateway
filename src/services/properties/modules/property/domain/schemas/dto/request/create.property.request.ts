...
export class CreatePropertyRequest {
  ...
  @ApiProperty({
    ...
    description: 'Client ID associated with the property',
    type: String,
  })
  ...
  @ApiProperty({
    example: 'Main St',
    description: 'Alleyway where the property is located',
    type: String,
  })
  ...
  @ApiProperty({
    example: 'Sector 1',
    description: 'Sector where the property is located',
    type: String,
  })
  ...
  @ApiProperty({
    example: 500.0,
    description: 'Land area of the property in square meters',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 300.0,
    description: 'Construction area of the property in square meters',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 100000.0,
    description: 'Land value of the property in currency units',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 150000.0,
    description: 'Construction value of the property in currency units',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 200000.0,
    description: 'Commercial value of the property in currency units',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 'REF-12345',
    description: 'Reference ID of the property',
    type: String,
  })
  ...
  @ApiProperty({
    example: 100.0,
    description: 'Altitude of the property in meters',
    type: Number,
  })
  ...
  @ApiProperty({
    example: 0.99,
    description: 'Precision of the property location',
    type: Number,
  })
